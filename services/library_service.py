...
def pay_late_fees(patron_id: str, book_id: int, payment_gateway: ps.PaymentGateway = None) -> Tuple[bool, str, Optional[str]]:
    """
    ...
    if payment_gateway is None:
        payment_gateway = ps.PaymentGateway()
...
def refund_late_fee_payment(transaction_id: str, amount: float, payment_gateway: ps.PaymentGateway = None) -> Tuple[bool, str]:
    """
